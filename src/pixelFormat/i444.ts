...
export function createI444Webgl(gl: WebGLRenderingContext): GlRenderer | Error {
    ...
    return {
        render: (frame: RenderFrame): void => {
            ...
            const uPixels = new Uint8Array(frame.data.slice(ySize, ySize*2));
            const vPixels = new Uint8Array(frame.data.slice(ySize*2, ySize*3));
