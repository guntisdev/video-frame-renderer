...
export function createRgbxWebgl(gl: WebGLRenderingContext): GlRenderer | Error {
...
function initTexture(
    ...
    const rgbaTexture = createWebglTexture(gl);
    if (!rgbaTexture) return new Error("Failed to create WebGL texture");
    gl.uniform1i(gl.getUniformLocation(program, "samplerRGBA"), 0);
