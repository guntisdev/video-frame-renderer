...
export function createI422Webgl(gl: WebGLRenderingContext): GlRenderer | Error {
    ...
    return {
        render: (frame: RenderFrame): void => {
            ...
            gl.texImage2D(gl.TEXTURE_2D, 0, gl.LUMINANCE, frame.codedWidth >> 1, frame.codedHeight, 0,
